...
def get_board_squares_from_image(image,board_size,
                                 square_size=(60,60),
                                middle_pixels=None):
    import cv2
    import numpy as np
    ...
    for r in range(nr):
        for c in range(nc):
            ...
            if middle_pixels:
                R=square_size[0]//2-middle_pixels//2
                C=square_size[1]//2-middle_pixels//2
                subim=subim[R:R+middle_pixels,C:C+middle_pixels,:]
